...
VANILLA_PORT = None
VANILLA_USER = None
VANILLA_PASSWORD = None
VANILLA_DB = None
VANILLA_SUPPORT = None
...
def initialize():
    ...
    with INIT_LOCK:
        ...
        VANILLA_HOST, VANILLA_PORT, VANILLA_USER, VANILLA_PASSWORD, VANILLA_DB, VANILLA_SUPPORT

        if __INITIALIZED__:
            return False

        CheckSection('General')
        CheckSection('VANILLA')
        ...
        SERVER_NAME = check_setting_str(CFG, 'General', 'server_name', 'Vanilla2Tender')
        ...
        VANILLA_HOST = check_setting_str(CFG, 'VANILLA', 'vanilla_host', '')
        VANILLA_PORT = check_setting_str(CFG, 'VANILLA', 'vanilla_port', '')
        VANILLA_USER = check_setting_str(CFG, 'VANILLA', 'vanilla_user', '')
        VANILLA_PASSWORD = check_setting_str(CFG, 'VANILLA', 'vanilla_password', '')
        VANILLA_DB = check_setting_str(CFG, 'VANILLA', 'vanilla_db', '')
        VANILLA_SUPPORT = check_setting_str(CFG, 'VANILLA', 'vanilla_support', '')
...
def config_write():
    ...
    new_config['VANILLA'] = {}
    new_config['VANILLA']['vanilla_host'] = VANILLA_HOST
    new_config['VANILLA']['vanilla_port'] = VANILLA_PORT
    new_config['VANILLA']['vanilla_user'] = VANILLA_USER
    new_config['VANILLA']['vanilla_password'] = VANILLA_PASSWORD
    new_config['VANILLA']['vanilla_db'] = VANILLA_DB
    new_config['VANILLA']['vanilla_support'] = VANILLA_SUPPORT
